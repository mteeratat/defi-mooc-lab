...
contract LiquidationOperator is IUniswapV2Callee {
    ...
    function operate() external {
        ...
        (uint256 reserve_WBTC_Pool3, uint256 reserve_USDT_Pool3, ) = uniswapV2Pair_WBTC_USDT.getReserves();
        console.log("reserve_WBTC_Pool3 = %s", reserve_WBTC_Pool3);
        console.log("reserve_USDT_Pool3 = %s", reserve_USDT_Pool3);
        console.log("debt_USDT = %s", debt_USDT);
        console.log("before swap");
        uniswapV2Pair_WBTC_USDT.swap(0, debt_USDT, address(this), "$"); // lab2.2
        console.log("swapped");
        ...
        // console.log("WBTC balance = %s", balance);
    ...
    function uniswapV2Call(
        ...
        // proof lab2.1 getAmountOut
        // uint K = 1000*reserve_WBTC_Pool2 * 1000*reserve_WETH_Pool2;
        // uint input = 997*collateral_WBTC + 1000*reserve_WBTC_Pool2;
        ...
        // console.log("collateral_WBTC + reserve_WBTC_Pool2: %s", input);
        // console.log("out-compute: %s", (1000*reserve_WETH_Pool2)-(K/input));
        ...
        // proof lab2.1 getAmountIn
        // uint K = 1000*reserve_USDT_Pool1 * 1000*reserve_WETH_Pool1;
        // uint input = 1000*(reserve_USDT_Pool1 - debtToCover);
        ...
        // console.log("reserve_USDT_Pool1 - debtToCover: %s", input);
        // console.log("in-compute: %s", 1003*((K/input)-(1000*reserve_WETH_Pool1))/1000);
        // console.log("repay_WETH: %s", repay_WETH);
        
        // END TODO

        // lab2.2
        uint debtToCover = 2000000000;
        USDT.approve(address(lendingPool), debtToCover);
        lendingPool.liquidationCall(address(WBTC), address(USDT), liquidationTarget, debtToCover, false);
        uint collateral_WBTC = WBTC.balanceOf(address(this));
        ...
        uint left_WBTC = collateral_WBTC - repay_WBTC;
        WBTC.transfer(address(uniswapV2Pair_WBTC_WETH), left_WBTC);
        uint amountOut_WETH = getAmountOut(left_WBTC, reserve_WBTC_Pool2, reserve_WETH_Pool2);
        uniswapV2Pair_WBTC_WETH.swap(0, amountOut_WETH, address(this), "");
        // lab2.2
    }
}
